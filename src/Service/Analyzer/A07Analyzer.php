...
class A07Analyzer
{
    ...
    private const PATTERNS = [
        ...
        [
            'id'          => 'a07.auth.hardcoded_password.other_langs',
            'regex'       => '/\bpassword\s*:?=\s*[\'"][^\'"]{3,}[\'"]/i',
            'title'       => 'Mot de passe hardcodé pour authentification',
            'description' => "Un mot de passe est écrit en dur dans le code. Utiliser des variables d'environnement.",
            'severity'    => Finding::SEVERITY_CRITICAL,
        ...
        [
            'id'          => 'a07.auth.cookie_no_httponly.python',
            'regex'       => '/set_cookie\s*\([^)]+\)/i',
            'title'       => 'Cookie créé sans flag HttpOnly',
            'description' => 'set_cookie() sans httponly=True expose le cookie aux scripts JavaScript.',
            'severity'    => Finding::SEVERITY_HIGH,
            'extensions'  => ['py'],
            'check'       => 'httponly',
        ],
        [
            'id'          => 'a07.auth.cookie_no_secure.python',
            'regex'       => '/set_cookie\s*\([^)]+\)/i',
            'title'       => 'Cookie créé sans flag Secure',
            'description' => 'set_cookie() sans secure=True permet la transmission du cookie en HTTP non chiffré.',
            'severity'    => Finding::SEVERITY_MEDIUM,
            'extensions'  => ['py'],
            'check'       => 'secure',
        ],
        [
            'id'          => 'a07.auth.cookie_no_httponly.ruby',
            'regex'       => '/cookies\[[^\]]+\]\s*=\s*\{[^}]+\}/i',
            'title'       => 'Cookie créé sans flag HttpOnly',
            'description' => 'cookies[...] = {...} sans httponly: true expose le cookie aux scripts JavaScript.',
            'severity'    => Finding::SEVERITY_HIGH,
            'extensions'  => ['rb'],
            'check'       => 'httponly',
        ],
        [
            'id'          => 'a07.auth.cookie_no_secure.ruby',
            'regex'       => '/cookies\[[^\]]+\]\s*=\s*\{[^}]+\}/i',
            'title'       => 'Cookie créé sans flag Secure',
            'description' => 'cookies[...] = {...} sans secure: true permet la transmission du cookie en HTTP non chiffré.',
            'severity'    => Finding::SEVERITY_MEDIUM,
            'extensions'  => ['rb'],
            'check'       => 'secure',
        ],
        [
            'id'          => 'a07.auth.cookie_no_httponly.go',
            'regex'       => '/&?http\.Cookie\{[^}]*\}/i',
            'title'       => 'Cookie créé sans flag HttpOnly',
            'description' => 'http.Cookie{...} sans HttpOnly: true expose le cookie aux scripts JavaScript.',
            'severity'    => Finding::SEVERITY_HIGH,
            'extensions'  => ['go'],
            'check'       => 'httponly',
        ],
        [
            'id'          => 'a07.auth.cookie_no_secure.go',
            'regex'       => '/&?http\.Cookie\{[^}]*\}/i',
            'title'       => 'Cookie créé sans flag Secure',
            'description' => 'http.Cookie{...} sans Secure: true permet la transmission du cookie en HTTP non chiffré.',
            'severity'    => Finding::SEVERITY_MEDIUM,
            'extensions'  => ['go'],
            'check'       => 'secure',
        ],
        [
            'id'          => 'a07.auth.cookie_flags.java',
            'regex'       => '/new\s+Cookie\s*\(/i',
            'title'       => 'Cookie créé — vérifier les flags HttpOnly/Secure',
            'description' => 'Un Cookie est instancié. Vérifier que setHttpOnly(true) et setSecure(true) sont bien appelés explicitement.',
            'severity'    => Finding::SEVERITY_MEDIUM,
            'extensions'  => ['java'],
        ],
        [
        ...
        [
            ...
            'severity'    => Finding::SEVERITY_HIGH,
            'extensions'  => ['php', 'html', 'twig', 'erb', 'jsp'],
        ],
        [
        ...
        [
            'id'          => 'a07.auth.jwt_no_verify.python',
            'regex'       => '/jwt\.decode\s*\(/i',
            'title'       => 'Décodage JWT sans vérification de signature',
            'description' => 'jwt.decode() est appelé — vérifier qu\'aucun paramètre verify=False n\'est passé et qu\'un algorithme et une clé forts sont utilisés.',
            'severity'    => Finding::SEVERITY_CRITICAL,
            'extensions'  => ['py'],
        ],
        [
            'id'          => 'a07.auth.jwt_no_verify.ruby',
            'regex'       => '/JWT\.decode\s*\(/i',
            'title'       => 'Décodage JWT sans vérification de signature',
            'description' => 'JWT.decode() est appelé — s\'assurer que la vérification de signature n\'est pas désactivée (verify: false).',
            'severity'    => Finding::SEVERITY_CRITICAL,
            'extensions'  => ['rb'],
        ],
        [
            'id'          => 'a07.auth.jwt_no_verify.java',
            'regex'       => '/Jwts\.parser|JWT\.decode\s*\(/i',
            'title'       => 'Décodage JWT sans vérification de signature',
            'description' => 'Un token JWT est décodé — vérifier que la signature est validée avec setSigningKey()/verify() avant de faire confiance au contenu.',
            'severity'    => Finding::SEVERITY_CRITICAL,
            'extensions'  => ['java'],
        ],
        [
            'id'          => 'a07.auth.jwt_no_verify.go',
            'regex'       => '/jwt\.Parse\s*\(/i',
            'title'       => 'Décodage JWT sans vérification de signature',
            'description' => 'jwt.Parse() est appelé — vérifier que la fonction de validation de clé (keyFunc) et l\'algorithme attendu sont correctement contrôlés.',
            'severity'    => Finding::SEVERITY_CRITICAL,
            'extensions'  => ['go'],
        ],
        [
        ...
        [
            'id'          => 'a07.auth.weak_password_policy.other_langs',
            'regex'       => '/(?:len\s*\(\s*password\s*\)|password\.length(?:\(\))?)\s*[<>]=?\s*[1-5][^0-9]/i',
            'title'       => 'Politique de mot de passe trop faible',
            'description' => 'La longueur minimale du mot de passe semble être inférieure à 8 caractères. Imposer minimum 12 caractères avec complexité.',
            'severity'    => Finding::SEVERITY_MEDIUM,
            'extensions'  => ['py', 'java', 'go', 'rb'],
